...
NSString * const ID = @"CZCycleScrollViewCell";


#define kCycleScrollViewInitialPageControlDotSize CGSizeMake(10, 10)

@interface CZCycleScrollView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)initialization
{
    _pageControlAliment = CZCycleScrollViewPageContolAlimentCenter;
...
{
    CZCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[CZCollectionViewCell class] forCellWithReuseIdentifier:ID];
...
- (void)setDelegate:(id<CZCycleScrollViewDelegate>)delegate
{
    _delegate = delegate;
...
- (void)setCurrentPageDotImage:(UIImage *)currentPageDotImage
{
    ...
    if (self.pageControlStyle != CZCycleScrollViewPageContolStyleAnimated) {
        self.pageControlStyle = CZCycleScrollViewPageContolStyleAnimated;
    }
...
- (void)setPageControlStyle:(CZCycleScrollViewPageContolStyle)pageControlStyle
{
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case CZCycleScrollViewPageContolStyleAnimated:
        {
        ...
        case CZCycleScrollViewPageContolStyleClassic:
        {
...
- (void)layoutSubviews
{
    ...
    if (self.pageControlAliment == CZCycleScrollViewPageContolAlimentRight) {
